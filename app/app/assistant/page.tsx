  ...
  const questions: QuickQuestion[] = [
    ...
    },
    {
      ...
      answer: {
        ...
        why: bestProduct
          ...
          : "เพิ่มข้อมูลต้นทุนและราคาขายก่อน ระบบจึงจะจัดอันดับสินค้าให้ได้",
    ...
    },
    {
      ...
      answer: {
        ...
        why: "ส่วนลด แคชแบ็ก ค่าส่ง และค่าโฆษณารวมกันอาจกินกำไรเกินเป้าที่ตั้งไว้",
        next: "กดปฏิเสธหรือปรับส่วนลดก่อนสมัครแคมเปญจริง",
      },
    },
    {
      id: "low-stock",
      ...
      answer: {
        ...
        what:
          lowStockProducts.length > 0
            ...
            : "ยังไม่มีสินค้าใกล้หมดจากเกณฑ์ 10 ชิ้น",
    ...
    },
    {
      ...
      answer: {
        ...
        next: "ไปหน้าแคมเปญเพื่ออนุมัติ/ปฏิเสธ แล้วเปิดหน้าโอกาสทำกำไรเพื่อเลือกงานถัดไป",
      },
    },
  ];
